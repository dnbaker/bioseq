...
if __name__ == "__main__":
    ...
    ext_modules = [Extension("cbioseq", ["src/bioseq.cpp", "src/tokenize.cpp", "src/omp.cpp", 'src/fxstats.cpp'], include_dirs=include_dirs, language='c++')]
    setup(
        name='bioseq',
        version=__version__,
        author='Daniel Baker',
        ...
        install_requires=['pybind11', 'numpy>=0.19', 'einops', 'torch', 'fast_transformer_pytorch', 'linear_attention_transformer'],
